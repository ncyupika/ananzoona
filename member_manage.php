								...
								<!--<h3>個人資料修改</h3>-->
													...
													<form method="post" action="#">
														...
														<div class="col-6 col-12-xsmall">
																...
																<input type="text" name="demo-name" id="demo-name" value="<?php echo $mail_address?>" placeholder="信箱" />
														</br>
																<input type="text" name="demo-name" id="demo-name" value="<?php echo $cellphone?>" placeholder="電話" />
														</br>
																<input type="text" name="demo-name" id="demo-name" value="<?php echo $address1?>" placeholder="通訊地址" />
														</br>
																<input type="text" name="demo-name" id="demo-name" value="<?php echo $address2?>" placeholder="戶籍地址" />
																種類: <?php echo $_SESSION['usertype'];?>
															</div>
															</br>
															<!-- Break -->
															<div class="col-12">
